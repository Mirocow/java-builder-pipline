...
public class BuildProject {
    ...
    public static void BuildMacOS()
    {
        ...
        Build(EnabledScenes, fullPathAndName, BuildTargetGroup.Standalone, BuildTarget.StandaloneOSX, BuildOptions.None);
    }
    ...
    public static void BuildWindows()
    {
        ...
        Build(EnabledScenes, fullPathAndName, BuildTargetGroup.Standalone, BuildTarget.StandaloneWindows64, BuildOptions.None);
    }
    ...
    public static void BuildLinux()
    {
        ...
        string fullPathAndName = args.targetDir + args.appName;
        Build(EnabledScenes, fullPathAndName, BuildTargetGroup.Standalone, BuildTarget.StandaloneLinux64, BuildOptions.None);
    }
    ...
    private static Args FindArgs()
    {
        ...
        if (!allArgsFound)
            System.Console.WriteLine("[JenkinsBuild] Incorrect Parameters for -executeMethod Format: -executeMethod JenkinsBuild.BuildWindows <app name> <output dir>");
    ...
    // ------------------------------------------------------------------------
    private static void Build(string[] scenes, string targetDir, BuildTargetGroup buildTargetGroup, BuildTarget buildTarget, BuildOptions buildOptions)
    {
    ...
    {		
        ...
        public string targetDir = Application.dataPath + "/" + "Output";
    }
}
